...
![Chart type: Bar Chart](images/page_22_pic_1.png)
...
Title: NarrativeQA, Quality, Qaspr
Axes: X — Layer, Y — Percentage
Trend: Model performance metrics (percentage) vary across layers, with BM25 consistently showing high scores in NarrativeQA and Qaspr for Layer 0, while Quality exhibits more balanced performance across models.
Key data points:
| Layer | NarrativeQA SBERT | NarrativeQA BM25 | NarrativeQA DPR | Quality SBERT | Quality BM25 | Quality DPR | Qaspr SBERT | Qaspr BM25 | Qaspr DPR |
|-------|-------------------|------------------|-----------------|---------------|--------------|-------------|-------------|------------|-----------|
| 0     | ~60               | ~65              | ~40             | ~70           | ~65          | ~65         | ~80         | ~75        | ~75       |
| 1     | ~30               | ~30              | ~45             | ~20           | ~25          | ~30         | ~15         | ~20        | ~20       |
| 2     | ~5                | ~5               | ~10             | ~0            | ~5           | ~5          | ~0          | ~0         | ~0        |
| 3     | ~0                | ~0               | ~2              | ...           | ...          | ...         | ...         | ...        | ...       |
| 4     | ~0                | ~0               | ~0              | ...           | ...          | ...         | ...         | ...        | ...       |
